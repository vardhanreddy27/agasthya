...
function ParallaxCardColumn({ items, baseVelocity = 8, onCardClick }) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-[70vh] w-full sm:w-[280px] overflow-hidden"
...
className="cursor-pointer relative h-[180px] w-[90vw] max-w-[280px] rounded-2xl shadow-md bg-cover bg-center flex items-end overflow-hidden mx-auto"
...
function VelocityScrollColumn({ defaultVelocity = 0.5, numColumns = 1, items, onCardClick }) {
  return (
    <div className="flex flex-row sm:flex-row justify-center gap-1 w-full">
    ...
    <section className="w-full px-4 py-12 bg-white">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-3xl md:text-5xl leading-tight mb-4 text-gray-900 drop-shadow-lg">
          ...
          <p className="text-gray-600 mt-2 max-w-xl mx-auto lg:mx-0">
        ...
        <div className="flex-1 w-full relative h-[60vh] sm:h-[80vh]">
